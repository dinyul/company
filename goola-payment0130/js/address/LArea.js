...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
            ...
            function popupArea(e) {
               _self.gearArea = document.createElement("div");
                ...
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    '</div>' +
                    '</div>';
                document.getElementById('more-show').appendChild(_self.gearArea);
                areaCtrlInit();
        ...
        setGearTooth: function(data) {
            ...
            if (l > 0) {
               // var id = item[gearVal][this.keys['id']];
                ...
                var itemStr = "";
                for (var i = 0; i < l; i++) {
                    itemStr += "<a href='"+ item[i][this.keys['href']] +"'><div class='tooth'  ref='" + item[i][this.keys['id']] + "'>" + item[i][this.keys['name']] + "</div></a>";
                }
        ...
        close: function(e) {
            ...
            document.getElementById('more-show').removeChild(_self.gearArea);
            _self.gearArea=null;
        }
    }
    return MobileArea;
