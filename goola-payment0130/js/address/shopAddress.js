...
var getAddressList
	(function(api, util, ajax){
		...
		//删除地址
		$('.guanlidizhi').delegate('.address-delete','click',function(){
		...
		//修改地址
		$('.guanlidizhi').delegate('.address-change','click',function(){
