	...
	(function(api, util, ajax){
		...
		$('.fenlei-content-list').delegate('.product','click',function(e){
			...
			window.location.href='/community/shangpin/shangpinxiangqing.html?goodsId='+goodsId
		})
		...
		//分类页面左侧导航栏信息获取
		function getList(){
			ajax.post(api.baseServerUrl + "/distributionSellTeamGoods/findAllGoodsCategory",{
		...
		function getgoodList(categoryId){
			ajax.post(api.baseServerUrl + "/distributionSellTeamGoods/queryGoodsByCId",{
